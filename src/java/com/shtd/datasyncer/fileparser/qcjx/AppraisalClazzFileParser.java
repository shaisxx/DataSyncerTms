 ...
 *
 */
public class AppraisalClazzFileParser {
	private static Logger logger = Logger.getLogger(Constant.LOGGER_NAME);
	
	private String mFilePathName = "";
	
	private List<AppraisalClazz> mClazzList = new ArrayList<AppraisalClazz>();
	
	
	public AppraisalClazzFileParser(String filePathName) {
	...
	public boolean doParse() {
		...
		try {
	        ...
	        // 得到文档名称为BJSJXX的元素的节点列表  
	        NodeList list = doc.getElementsByTagName(AppraisalClazz.ELEMENT_NAME_CLAZZ);
	        ...
	        for(int i=0; i<list.getLength(); i++) {  
	        	AppraisalClazz clazz = new AppraisalClazz();
	...
	public List<AppraisalClazz> getmClazzList() {
		return mClazzList;
	}
}
