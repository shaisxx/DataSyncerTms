...
public class TeacherFileParser {
	...
	public boolean doParse() {
		...
		try {
	        ...
	        NodeList list = doc.getElementsByTagName(Teacher.ELEMENT_NAME_TEACHER);
	        ...
	        for(int i=0; i<list.getLength(); i++) {  
	            ...
	            teacher.setName(getElementValueByTagName(element, Teacher.ELEMENT_NAME_NAME));
	            teacher.setSenFenZheng(getElementValueByTagName(element, Teacher.ELEMENT_NAME_SHENFENZHENG));
	            teacher.setStatus(getElementValueByTagName(element, Teacher.ELEMENT_NAME_STATUS_CODE));
	            teacher.setGongHao(getElementValueByTagName(element, Teacher.ELEMENT_NAME_GONGHAO));  
	            teacher.setDanWei(getElementValueByTagName(element, Teacher.ELEMENT_NAME_DANWEI));  
	            teacher.setGender(getElementValueByTagName(element, Teacher.ELEMENT_NAME_GENDER));  
