 ...
 *
 */
public class WhicoClazzFileParser {
...
//	private static final String PARSED_FILE_EXT_NAME = ".parsed";
	...
	public WhicoClazzFileParser(String filePathName) {
	...
	public boolean doParse() {
		...
		try {
	        ...
	        NodeList list = doc.getElementsByTagName(WhicoClazz.ELEMENT_NAME_CLAZZ);
	        ...
	        for(int i=0; i<list.getLength(); i++) {  
	            ...
	            clazz.setGrade(getElementValueByTagName(element, "JBNY"));
	            ...
	            System.out.println("\t"+(i+1)
	            		          ...
	            		          +"\t"+getElementValueByTagName(element, "JBNY")
	            		);
	        }
	        return true;
