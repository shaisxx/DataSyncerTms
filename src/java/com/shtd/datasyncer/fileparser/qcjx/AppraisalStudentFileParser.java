...
public class AppraisalStudentFileParser {
	...
	private List<AppraisalStudent> mStudentList = new ArrayList<AppraisalStudent>();
	
	public AppraisalStudentFileParser(String filePathName) {
		mFilePathName = filePathName;
	}
	
	public List<AppraisalStudent> getStudentList(){
		return mStudentList;
	}
	...
	public boolean doParse() {
		...
		try {
	        ...
	        NodeList list = doc.getElementsByTagName(AppraisalStudent.ELEMENT_NAME_STUDENT);
	        ...
	        for(int i=0; i<list.getLength(); i++) {  
	            ...
	            AppraisalStudent student = new AppraisalStudent();
	            student.setStuName(getElementValueByTagName(element, AppraisalStudent.ELEMENT_NAME_NAME));
	            student.setStuNo(getElementValueByTagName(element, AppraisalStudent.ELEMENT_NAME_NO));
	            student.setStuGender(getElementValueByTagName(element, AppraisalStudent.ELEMENT_NAME_GENDER));
	            student.setStuSenFenZheng(getElementValueByTagName(element, AppraisalStudent.ELEMENT_NAME_SHENFENZHENG));
