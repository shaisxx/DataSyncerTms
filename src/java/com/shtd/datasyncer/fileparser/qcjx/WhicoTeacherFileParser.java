...
public class WhicoTeacherFileParser {
	...
	private List<WhicoTeacher> mTeacherList = new ArrayList<WhicoTeacher>();
	
	public WhicoTeacherFileParser(String filePathName) {
		mFilePathName = filePathName;
	}
	
	public List<WhicoTeacher> getTeacherList() {
		return mTeacherList;
	}
	...
	public boolean doParse() {
		...
		try {
	        ...
	        NodeList list = doc.getElementsByTagName(WhicoTeacher.ELEMENT_NAME_TEACHER);
	        ...
	        for(int i=0; i<list.getLength(); i++) {  
	            ...
	            WhicoTeacher teacher = new WhicoTeacher();
	            teacher.setName(getElementValueByTagName(element, WhicoTeacher.ELEMENT_NAME_NAME));
	            teacher.setSenFenZheng(getElementValueByTagName(element, WhicoTeacher.ELEMENT_NAME_SHENFENZHENG));
	            teacher.setStatus(getElementValueByTagName(element, WhicoTeacher.ELEMENT_NAME_STATUS_CODE));
	            teacher.setGongHao(getElementValueByTagName(element, WhicoTeacher.ELEMENT_NAME_GONGHAO));  
	            teacher.setDanWei(getElementValueByTagName(element, WhicoTeacher.ELEMENT_NAME_DANWEI));  
	            teacher.setGender(getElementValueByTagName(element, WhicoTeacher.ELEMENT_NAME_GENDER));  
